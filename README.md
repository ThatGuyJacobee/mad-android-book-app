...
This small project was part of the MAD (Mobile App Development) module during my final year at university. This was the first time working with Kotlin to create a native Android application.

The app was developed over the course of a few weeks and was split up into various sprints which were worked on solo alongside some of the teaching materials. Some of the functionality includes full CRUDL for books, alongside page tracking and export functionality.
